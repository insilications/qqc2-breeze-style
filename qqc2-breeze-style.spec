...
Version  : 5.23.5
Release  : 303
URL      : https://download.kde.org/stable/plasma/5.23.5/qqc2-breeze-style-5.23.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.5/qqc2-breeze-style-5.23.5.tar.xz
...
%prep
%setup -q -n qqc2-breeze-style-5.23.5
cd %{_builddir}/qqc2-breeze-style-5.23.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643438344
mkdir -p clr-build
pushd clr-build
